...
#pragma warning restore CS8618
    ...
    {
        return Matchers.FirstOrDefault(matcher => matcher.Match(address.GetAddressBytes()));
    }
}

public record AggregationLayerDto(string Type, string? Name, bool Enabled, List<IpAddressMatcherDto> Matchers)
    : ILayerDto;