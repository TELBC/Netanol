                            ...
                            rawPacketHeader.Packet.Ethernet.IsValid)
                        {
                            if (rawPacketHeader.Packet.Ethernet.EtherType == EthernetType.VLanTaggedFrame)
                            {
                                ...
                                (
                                    ...
                                    IPAddress.Parse(rawPacketHeader.Packet.Ethernet.VLanTaggedFrame.IpV4.Source.ToString()),
                                    rawPacketHeader.Packet.Ethernet.VLanTaggedFrame.IpV4.Tcp.SourcePort,
                                    IPAddress.Parse(rawPacketHeader.Packet.Ethernet.VLanTaggedFrame.IpV4.Destination.ToString()),
                                     ...
                                     rawPacketHeader.Packet.Ethernet.IpV6.IsValid)
                            {
                                ...
                                (
                                    ...
                                    IPAddress.Parse(rawPacketHeader.Packet.Ethernet.IpV6.CurrentDestination.ToString()), // Destination does not exist in PcapDotNet apparently
